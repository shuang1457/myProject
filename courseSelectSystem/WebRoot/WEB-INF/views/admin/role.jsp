		...
		dataGrid = $('#dataGrid').datagrid({
			...
			frozenColumns : [ [ {
				...
				formatter : function(value, row, index) {
					var str = '&nbsp;';
						if ($.canGrant) {
							str += $.formatString('<a href="javascript:void(0)" onclick="grantFun(\'{0}\');" style="color:#993300" onmouseover="this.style.cssText=\'color:#0b806f; text-decoration:none;\'" onmouseout="this.style.cssText=\'color:#993300;text-decoration:none\'" >授权</a>', row.id);
						}
					if(row.isdefault!=0){
						str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
						if ($.canEdit) {
