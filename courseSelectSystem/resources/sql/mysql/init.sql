...
-- [机构]
--
insert into sys_organization(id,name,address,code,icon,pid,seq,createdatetime) values(1,'JAVA开发框架','地址','01','icon-company',null,0,'2014-02-19 01:00:00');
...
create table t_course_select (
	...
	other1 varchar(50),
	primary key (id)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='选课记录表';


INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2013-03-12 11:13:05','2013','英语','王迅','张三','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2013-03-12 11:13:05','2013','文学','李丽梅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','高数','王迅','王涛','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','计算机','李刚','张三','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','英语','王迅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','离散数学','王迅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','英语','王迅','张三','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','计算机','王迅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','英语','王迅','张三','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','文学','李刚','王涛','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','文学','李丽梅','张三','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','高数','李刚','王涛','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','计算机','王迅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','高数','王迅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','计算机','李丽梅','张三','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','高数','王迅','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','离散数学','李四','王五','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','离散数学','李丽梅','王涛','无');
INSERT INTO `xkxt`.`t_course_select`(`date`,`year`,`courseName`,`studentName`,`teacherName`,`other1`) VALUES ('2014-03-12 11:13:05','2014','计算机','李丽梅','王五','无');
